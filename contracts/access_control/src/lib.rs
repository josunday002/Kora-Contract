...
//!
//! Provides protocol-wide authorization and pause controls for the Kora Protocol.
//!
//! This contract manages:
//! - **Role-based access control** — Admin, Operator, Verifier, and None roles
//! - **Protocol pause switch** — Emergency pause/unpause mechanism
//! - **Admin transfer** — Secure handover of protocol control
//!
//! See [Access Control Model](../../../docs/access-control.md) for detailed architecture.
...
/// Role variants in the Kora Protocol's access control system.
///
/// # Roles
/// - **Admin** — Full protocol control; can pause, grant/revoke roles, transfer admin status
/// - **Operator** — Reserved for future use (e.g., keeper bots for automation)
/// - **Verifier** — Can register SMEs and assign risk scores (managed by `risk_registry`)
/// - **None** — No special privileges; default role for unassigned addresses
#[contracttype]
...
impl AccessControlContract {
    ...
    /// Get the role assigned to a given address.
    ///
    /// **Parameters:**
    ...
    ///
    /// **Returns:** The admin's address, or `KoraError::NotInitialized` if the contract
